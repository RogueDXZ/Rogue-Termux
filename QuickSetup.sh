...
apt update -y && apt upgrade -y && apt install python mpv w3m cmatrix tmate tmux sox wol openssh termux-api neofetch htop speedtest-go nmap ani-cli termimage git nnn man gh tealdeer tizonia
